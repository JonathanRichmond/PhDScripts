...
BCR4BPManifold::MBD.BCR4BP12Manifold = getManifoldByArclength(orbit1, "Unstable", "Negative", 25/get12CharLength(systemData), 100*p1)
BCR4BPManifold.TOF = propTime
CR3BPManifold::MBD.CR3BPManifold = getManifoldByArclength(compOrbit1, "Unstable", "Negative", 25/getCharLength(CR3BPSystemData), 100)
