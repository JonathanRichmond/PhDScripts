...
initialStateGuess::Vector{Float64} = [0.881995, 0, -0.24036, 0, 0.144858, 0] # [0.850522, 0, -0.177117, 0, 0.255761, 0]
tSpanGuess::Vector{Float64} = [0, 20.3756] # [0, 18.0561] 
targetJC::Float64 = 2.9833 # 3.0098
numSegs::Int64 = 28
