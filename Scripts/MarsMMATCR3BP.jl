...
for day::Int64 in 1:length(days)
    ...
    for d::Int64 in 1:length(departureArcs)
        ...
        q_dep_SoI_SI::Vector{Float64} = rotatingToSunEclipJ2000(SEDynamicsModel, initialEpoch, [getStateByIndex(departureArcSEProp, -1)], [(days[day]*300*24+t_departure)/tstarSE])[1]
