...
guessOrbit1::MBD.CR3BPPeriodicOrbit = interpOrbit(CR3BPTargeter, "FamilyData/CR3BPEML1Lyapunovs.csv", "Period", CR3BPP*q1/p1)
...
compOrbit1::MBD.CR3BPPeriodicOrbit = interpOrbit(CR3BPTargeter, "FamilyData/CR3BPEML1Lyapunovs.csv", "Period", targetP*q1/p1)

p2::Int64, q2::Int64 = 3, 2
guessOrbit2::MBD.CR3BPPeriodicOrbit = interpOrbit(CR3BPTargeter, "FamilyData/CR3BPEML1Lyapunovs.csv", "Period", CR3BPP*q2/p2)
...
compOrbit2::MBD.CR3BPPeriodicOrbit = interpOrbit(CR3BPTargeter, "FamilyData/CR3BPEML1Lyapunovs.csv", "Period", targetP*q2/p2)
