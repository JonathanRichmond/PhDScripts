"""
Script for Sun-Venus CR3BP L2 southern halo orbit family

Author: Jonathan LeFevre Richmond
C: 2/18/26
"""
# module SML2Halo
println("Running SVL2Halos.jl...\n")
...
initialStateGuess::Vector{Float64} = [1.0078099281694801, 0, 0, 0, 0.009214458097847836, 0]
tSpanGuess::Vector{Float64} = [0, 3.102321981691777]
...
# fullExportCR3BPFamily(family, "FamilyData/CR3BPSVL2Halos.mat", "FamilyData/CR3BPSVL2Halos.csv", :L2Halos)

# println("\nTesting interpolation...")
# testOrbit::MBD.CR3BPPeriodicOrbit = interpOrbit(targeter, "FamilyData/CR3BPSVL2Halos.csv", "JC", 3.0003)
...
# end
# (figure, axis) = set3DPlotParameters(L"Sun-Venus $L_{2}$ Halo ($JC=%$(round(getJacobiConstant(dynamicsModel, family.initialConditions[plotOrbit]); digits = 6))$)", L"$x$ [ndim]", L"$y$ [ndim]", L"$z$ [ndim]")
