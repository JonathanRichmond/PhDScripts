"""
Script for Sun-Mars CR3BP L2 Lyapunov orbit family

Author: Jonathan LeFevre Richmond
C: 1/24/26
"""
# module SML2Lyap
println("Running SML2Lyapunovs.jl...\n")
...
(initialStateGuess::Vector{Float64}, tSpanGuess::Vector{Float64}) = getLinearVariation(dynamicsModel, 2, LagrangePoints[2], [-0.00001, 0, 0])
...
ydot0JumpCheck = MBD.BoundingBoxJumpCheck("Initial State", [NaN NaN; 0 0.1])
...
# fullExportCR3BPFamily(family, "FamilyData/CR3BPSML2Lyapunovs.mat", "FamilyData/CR3BPSML2Lyapunovs.csv", :L2Lyapunovs)

println("\nTesting interpolation...")
testOrbit::MBD.CR3BPPeriodicOrbit = interpOrbit(targeter, "FamilyData/CR3BPSML2Lyapunovs.csv", "JC", 3.0; JTol = 2E-2)
...
(figure, axis) = set2DPlotParameters(L"Sun-Mars $L_{2}$ Lyapunov ($JC=%$(round(getJacobiConstant(dynamicsModel, family.initialConditions[plotOrbit]); digits = 6))$)", L"$x$ [ndim]", L"$y$ [ndim]")
