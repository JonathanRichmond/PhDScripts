"""
Script for Sun-B1 CR3BP L2 Lyapunov orbit family
...
# fullExportCR3BPFamily(family, "FamilyData/CR3BPSB1L2Lyapunovs.mat", "FamilyData/CR3BPSB1L2Lyapunovs.csv", :L2Lyapunovs)

# println("\nTesting interpolation...")
# testOrbit::MBD.CR3BPPeriodicOrbit = interpOrbit(targeter, "FamilyData/CR3BPSB1L2Lyapunovs.csv", "JC", 3.0)
...
(figure, axis) = set2DPlotParameters(L"Sun-$B_{1}$ $L_{2}$ Lyapunov ($JC=%$(round(getJacobiConstant(dynamicsModel, family.initialConditions[plotOrbit]); digits = 4))$)", L"$x$ [ndim]", L"$y$ [ndim]")
