"""
Script for Sun-Mars CR3BP L1 southern halo orbit family

Author: Jonathan LeFevre Richmond
C: 1/24/26
"""
# module SML1Halo
println("Running SML1Halos.jl...\n")
...
initialStateGuess::Vector{Float64} = [0.996011330729216, 0, 0, 0, -0.0045714168753920965, 0]
tSpanGuess::Vector{Float64} = [0, 3.0712422188393305]
...
# fullExportCR3BPFamily(family, "FamilyData/CR3BPSML1Halos.mat", "FamilyData/CR3BPSML1Halos.csv", :L1Halos)

# println("\nTesting interpolation...")
# testOrbit::MBD.CR3BPPeriodicOrbit = interpOrbit(targeter, "FamilyData/CR3BPSML1Halos.csv", "JC", 3.0001)
...
# end
# (figure, axis) = set3DPlotParameters(L"Sun-Mars $L_{1}$ Halo ($JC=%$(round(getJacobiConstant(dynamicsModel, family.initialConditions[plotOrbit]); digits = 6))$)", L"$x$ [ndim]", L"$y$ [ndim]", L"$z$ [ndim]")
