"""
Script for Earth-Moon CR3BP 2:1 prograde resonant orbit family
    ***NEED TO CLASSIFY***
...
initialStateGuess::Vector{Float64} = [0.872326, 0, 0, 0, -0.290687, 0]
...
ydot0JumpCheck = MBD.BoundingBoxJumpCheck("Initial State", [NaN NaN; -2.0 0])
...
# fullExportCR3BPFamily(family, "FamilyData/CR3BPEMResonant2_1Pros.mat", "FamilyData/CR3BPEMResonant2_1Pros.csv", :Resonant2_1Pros)

# println("\nTesting interpolation...")
# testOrbit::MBD.CR3BPPeriodicOrbit = interpOrbit(targeter, "FamilyData/CR3BPEMResonant2_1Pros.csv", "JC", 3.0)
...
# end
# (figure, axis) = set2DPlotParameters(L"Earth-Moon $2:1$ Prograde Resonant Orbit ($JC=%$(round(getJacobiConstant(dynamicsModel, family.initialConditions[plotOrbit]); digits = 4))$)", L"$x$ [ndim]", L"$y$ [ndim]")
# GLMakie.lines!(axis, xData, yData, color = :white, label = L"$2:1$ Prograde Resonant Orbit")
