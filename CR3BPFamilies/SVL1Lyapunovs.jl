"""
Script for Sun-Venus CR3BP L1 Lyapunov orbit family

Author: Jonathan LeFevre Richmond
C: 2/9/26
"""
# module SVL1Lyap
println("Running SVL1Lyapunovs.jl...\n")
...
(initialStateGuess::Vector{Float64}, tSpanGuess::Vector{Float64}) = getLinearVariation(dynamicsModel, 1, LagrangePoints[1], [0.0001, 0, 0])
...
# fullExportCR3BPFamily(family, "FamilyData/CR3BPSVL1Lyapunovs.mat", "FamilyData/CR3BPSVL1Lyapunovs.csv", :L1Lyapunovs)

# println("\nTesting interpolation...")
# testOrbit::MBD.CR3BPPeriodicOrbit = interpOrbit(targeter, "FamilyData/CR3BPSVL1Lyapunovs.csv", "JC", 3.0)
...
# end
# (figure, axis) = set2DPlotParameters(L"Sun-Venus $L_{1}$ Lyapunov ($JC=%$(round(getJacobiConstant(dynamicsModel, family.initialConditions[plotOrbit]); digits = 6))$)", L"$x$ [ndim]", L"$y$ [ndim]")
