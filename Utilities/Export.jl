...
export exportBCR4BP12Trajectory, exportCR3BPOrbit, exportCR3BPTrajectory
...
"""
    exportBCR4BP12Trajectory(x, y, z, xdot, ydot, zdot, t, theta4, file)
...
"""
function exportBCR4BP12Trajectory(x::Vector{Float64}, y::Vector{Float64}, z::Vector{Float64}, xdot::Vector{Float64}, ydot::Vector{Float64}, zdot::Vector{Float64}, theta4::Vector{Float64}, t::Vector{Float64}, file::MATLAB.MatFile)
    traj = BCR4BP12Traj(x, y, z, xdot, ydot, zdot, theta4, t)
    MATLAB.put_variable(file, :trajBCR4BP12, traj)
end

"""
    exportCR3BPOrbit(orbit, dynamicsModel, file)
...
- `file::MatFile`: MAT file
"""
function exportCR3BPOrbit(orbit::MBD.CR3BPPeriodicOrbit, dynamicsModel::MBD.CR3BPDynamicsModel, file::MATLAB.MatFile)
    ...
    exportCR3BPTrajectory(x, y, z, xdot, ydot, zdot, t, file)
end
...
- `file::MatFile`: MAT file
"""
function exportCR3BPTrajectory(x::Vector{Float64}, y::Vector{Float64}, z::Vector{Float64}, xdot::Vector{Float64}, ydot::Vector{Float64}, zdot::Vector{Float64}, t::Vector{Float64}, file::MATLAB.MatFile)
    traj = CR3BPTraj(x, y, z, xdot, ydot, zdot, t)
    MATLAB.put_variable(file, :trajCR3BP, traj)
end
