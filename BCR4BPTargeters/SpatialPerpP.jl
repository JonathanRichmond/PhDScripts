...
"""
function correct(targeter::SpatialPerpP12Targeter, qVector::Vector{Vector{Float64}}, tVector::Vector{Float64}, numNodes::Int64; tol::Float64 = 1E-11, JTol::Float64 = 2E-3)
...
- `JTol::Float64`: Jacobian accuracy tolerance (default = 2E-3)
"""
function getResonantOrbit(targeter::SpatialPerpP12Targeter, initialOrbit::MBD.CR3BPPeriodicOrbit, numSegs::Int64, theta40::Float64, p::Int64, q::Int64, boundingBoxJumpCheck::MBD.BoundingBoxJumpCheck; targeteps::Float64 = 1.0, Deltaeps = 0.001, tol = 1E-11, refTol = 1E-11, JTol = 2E-3)
    ...
    targeterEnd = SpatialPerpP12Targeter(dynamicsModelEnd)
